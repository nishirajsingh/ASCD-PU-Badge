...
const TEMPLATE: Template = {
  title: "Proud to be volunteering",
...
export default function Page() {
  ...
  const downloadImage = () => {
    ...
    a.href = url
    a.download = "volunteer-badge.png"
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-[#FF9900]">ASCDPU - Volunteer Badge Maker</h1>
          <p className="text-sm sm:text-lg text-gray-700 mt-2 sm:mt-3">
            Create your AWS Student Community Day volunteer badge with ease
          </p>
        </div>
